    ...
    <body>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                            echo "<a href='/log_detail.php?sn=".$row["sn"]."'>";
                            echo $row["yyyymmdd"];
                            echo "</a>";
                        ?>
                    ...
                    <td>
                        ...
                        <?php
                            ...
                            echo "<td><a href='/php/log_delete_form.php?board_no=".$row["sn"]."'>삭제</a></td>";
                        ?>
                </tr>
            <?php
                }
        ...
        <?php
            ...
            if($currentPage > 1 ) { 
                ...
                echo "<a class='btn btn-primary' href ='/log_list.php?currentPage=".($currentPage-1)."'>이전</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            }
            ...
            if($currentPage < $lastPage) { 
                ...
                echo "<a class='btn btn-primary' href='/log_list.php?currentPage=".($currentPage+1)."'>다음</a>";
            }
            mysqli_close($conn);
        ?>
        &nbsp;&nbsp;
